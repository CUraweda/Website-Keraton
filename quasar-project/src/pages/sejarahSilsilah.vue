<template>
  <div>
    ...
    <!-- <div v-for="(item, index) in sultans" :key="index">
...
.background-silsilah {
  background: url("../assets/images/SilsilahSejarah.png");
