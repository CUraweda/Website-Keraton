  ...
  <div>
    ...
    <section ref="section2" class="flex items-center justify-center column">
      <div class="text-h3 text-center q-mt-md">
        <span class="text-bold">Mengenal</span> sejarah dan budaya Cirebon
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      imgFasilitas: [
        { img: "../src/assets/images/image33.png", text: "Ruang Pameran" },
        { img: "../src/assets/images/card2.png", text: "Ruang Audio Visual" },
        { img: "../src/assets/images/card3.png", text: "Ruang Kelas" },
        {
          img: "../src/assets/images/card4Museum.png",
...
.background-baluarti {
  background: url("../src/assets/images/museumPusakaa.png");
  display: flex;
  padding: 9.5rem 0;
